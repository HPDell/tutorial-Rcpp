...
// fibonacci_seq
std::vector<int> fibonacci_seq_std(size_t n);
RcppExport SEXP _DemoRcpp_fibonacci_seq(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter<size_t>::type n(nSEXP);
    rcpp_result_gen = Rcpp::wrap(fibonacci_seq_std(n));
    return rcpp_result_gen;
END_RCPP
}

// fibonacci_sum
double fibonacci_sum_std(size_t n, std::vector<double> weights);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fibonacci_sum_std(n, weights));
    return rcpp_result_gen;
END_RCPP
}
